...
pub struct EpisodesApiClient<C: hyper::client::connect::Connect> {
    configuration: Rc<configuration::Configuration<C>>,
}

impl<C: hyper::client::connect::Connect> EpisodesApiClient<C> {
    pub fn new(configuration: Rc<configuration::Configuration<C>>) -> EpisodesApiClient<C> {
        EpisodesApiClient { configuration }
    }
}
    ...
    ) -> Box<dyn Future<Item = crate::models::EpisodeRecordData, Error = Error<serde_json::Value>>>
    {
        ...
        Box::new(
            configuration
                ...
                .and_then(|body| {
                    let parsed: Result<crate::models::EpisodeRecordData, _> =
