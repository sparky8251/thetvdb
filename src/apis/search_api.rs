...
pub trait SearchApi {
    fn search_series_get(&self, name: &str, imdb_id: &str, zap2it_id: &str, slug: &str, accept_language: &str) -> Box<Future<Item = crate::models::SeriesSearchResults, Error = Error<serde_json::Value>>>;
    fn search_series_params_get(&self, ) -> Box<Future<Item = crate::models::EpisodeDataQueryParams, Error = Error<serde_json::Value>>>;
}
...
impl<C: hyper::client::Connect>SearchApi for SearchApiClient<C> {
    fn search_series_get(&self, name: &str, imdb_id: &str, zap2it_id: &str, slug: &str, accept_language: &str) -> Box<Future<Item = crate::models::SeriesSearchResults, Error = Error<serde_json::Value>>> {
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<crate::models::SeriesSearchResults, _> = serde_json::from_slice(&body);
    ...
    fn search_series_params_get(&self, ) -> Box<Future<Item = crate::models::EpisodeDataQueryParams, Error = Error<serde_json::Value>>> {
        ...
        let uri_str = format!("{}/search/series/params?{}", configuration.base_path, query_string);
        ...
        configuration.client.request(req)
            ...
            .and_then(|body| {
                let parsed: Result<crate::models::EpisodeDataQueryParams, _> = serde_json::from_slice(&body);
                parsed.map_err(|e| Error::from(e))
            })
        )
    }
