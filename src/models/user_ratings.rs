...
impl UserRatings {
  ...
  pub fn with_rating(mut self, rating: i32) -> UserRatings {
    self.rating = Some(rating);
    self
  }
  ...
  pub fn set_rating_item_id(&mut self, rating_item_id: i32) {
    self.rating_item_id = Some(rating_item_id);
  }

  pub fn with_rating_item_id(mut self, rating_item_id: i32) -> UserRatings {
    self.rating_item_id = Some(rating_item_id);
    self
  }

  pub fn rating_item_id(&self) -> Option<&i32> {
