...
impl Episode {
    ...
    pub fn with_absolute_number(mut self, absolute_number: i32) -> Episode {
        self.absolute_number = Some(absolute_number);
        self
    }
    ...
    pub fn with_aired_episode_number(mut self, aired_episode_number: i32) -> Episode {
        self.aired_episode_number = Some(aired_episode_number);
        self
    }
    ...
    pub fn with_aired_season(mut self, aired_season: i32) -> Episode {
        self.aired_season = Some(aired_season);
        self
    }
    ...
    pub fn set_airs_after_season(&mut self, airs_after_season: i32) {
        self.airs_after_season = Some(airs_after_season);
    }

    pub fn with_airs_after_season(mut self, airs_after_season: i32) -> Episode {
        self.airs_after_season = Some(airs_after_season);
        self
    }

    pub fn airs_after_season(&self) -> Option<&i32> {
    ...
    pub fn set_airs_before_episode(&mut self, airs_before_episode: i32) {
        self.airs_before_episode = Some(airs_before_episode);
    }

    pub fn with_airs_before_episode(mut self, airs_before_episode: i32) -> Episode {
        self.airs_before_episode = Some(airs_before_episode);
        self
    }

    pub fn airs_before_episode(&self) -> Option<&i32> {
    ...
    pub fn set_airs_before_season(&mut self, airs_before_season: i32) {
        self.airs_before_season = Some(airs_before_season);
    }

    pub fn with_airs_before_season(mut self, airs_before_season: i32) -> Episode {
        self.airs_before_season = Some(airs_before_season);
        self
    }

    pub fn airs_before_season(&self) -> Option<&i32> {
    ...
    pub fn set_dvd_chapter(&mut self, dvd_chapter: f32) {
        self.dvd_chapter = Some(dvd_chapter);
    }

    pub fn with_dvd_chapter(mut self, dvd_chapter: f32) -> Episode {
        self.dvd_chapter = Some(dvd_chapter);
        self
    }

    pub fn dvd_chapter(&self) -> Option<&f32> {
    ...
    pub fn set_dvd_episode_number(&mut self, dvd_episode_number: f32) {
        self.dvd_episode_number = Some(dvd_episode_number);
    }

    pub fn with_dvd_episode_number(mut self, dvd_episode_number: f32) -> Episode {
        self.dvd_episode_number = Some(dvd_episode_number);
        self
    }

    pub fn dvd_episode_number(&self) -> Option<&f32> {
    ...
    pub fn with_dvd_season(mut self, dvd_season: i32) -> Episode {
        self.dvd_season = Some(dvd_season);
        self
    }
    ...
    pub fn with_id(mut self, id: i32) -> Episode {
        self.id = Some(id);
        self
    }
    ...
    pub fn with_last_updated(mut self, last_updated: i32) -> Episode {
        self.last_updated = Some(last_updated);
        self
    }
    ...
    pub fn with_site_rating(mut self, site_rating: f32) -> Episode {
        self.site_rating = Some(site_rating);
        self
    }
    ...
    pub fn with_site_rating_count(mut self, site_rating_count: i32) -> Episode {
        self.site_rating_count = Some(site_rating_count);
        self
    }
    ...
    pub fn set_thumb_author(&mut self, thumb_author: i32) {
        self.thumb_author = Some(thumb_author);
    }

    pub fn with_thumb_author(mut self, thumb_author: i32) -> Episode {
        self.thumb_author = Some(thumb_author);
        self
    }

    pub fn thumb_author(&self) -> Option<&i32> {
