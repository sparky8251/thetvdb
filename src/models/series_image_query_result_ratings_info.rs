...
impl SeriesImageQueryResultRatingsInfo {
  pub fn new() -> SeriesImageQueryResultRatingsInfo {
  ...
  pub fn with_average(mut self, average: f32) -> SeriesImageQueryResultRatingsInfo {
    self.average = Some(average);
    self
  }
  ...
  pub fn with_count(mut self, count: i32) -> SeriesImageQueryResultRatingsInfo {
    self.count = Some(count);
    self
  }
