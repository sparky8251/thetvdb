...
impl SeriesEpisodes {
    ...
    pub fn with_data(mut self, data: Vec<crate::models::Episode>) -> SeriesEpisodes {
        self.data = Some(data);
        self
    }
    ...
    pub fn with_errors(mut self, errors: crate::models::JsonErrors) -> SeriesEpisodes {
        self.errors = Some(errors);
        self
    }
    ...
    pub fn with_links(mut self, links: crate::models::Links) -> SeriesEpisodes {
        self.links = Some(links);
        self
    }
